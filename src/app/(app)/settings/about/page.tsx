        ...
        <CardContent className="flex flex-col gap-4 text-sm">
          <ol className="flex flex-col gap-3">
            {[
              [
                "Читаем всё",
                "Каждый сайт, блог и канал из твоего списка — целиком, без пропусков. Популярное и обсуждаемое сюда не попадает: списки составляешь ты.",
              ],
              [
                "Спрашиваем про каждую новость одно и то же",
                "Событие это или пересказ старого. Есть ли цифры и названный источник. Надолго ли это. Честен ли заголовок. Одни и те же вопросы каждой новости — поэтому их ответы можно сравнивать между собой.",
              ],
              [
              ...
              [
                ...
                "Заголовок называет, что изменилось; описание начинается там, где заголовок закончил. Язык, сложность и манера — те, что ты выбрал.",
              ],
