...
export const feed = {
  ...
  item: {
    ...
    opinion: "Post draft",
    opinionAria: "Post draft in your voice",
    opinionTooltipReady: "Two drafts each for Telegram, X, LinkedIn and Threads",
    opinionTooltipLocked: (plan: string) => `Post draft — on the ${plan} plan`,
