...
export const settings = {
  ...
  personalization: {
    ...
    aboutHint: "The more detail you give, the more precisely we'll pick the stories that matter to you.",
  ...
  delivery: {
    general: "The issue is built at 2 a.m. in your time zone. Where it arrives is up to the channels below.",
    telegram: {
      description: "The issue as a message: headlines by topic and a link to each story.",
      connected: (username: string | null) => `Connected${username ? ` as @${username}` : ""}.`,
      connect: "Connect Telegram",
      connectHint: "The bot opens — tap Start, and the issue will arrive in Telegram too.",
      noBot: "The bot isn't available right now — try later.",
      change: "Change account",
      remove: "Disconnect Telegram",
      removed: "Telegram disconnected",
      onlyWay: "You can't disconnect it: it's your only way to sign in. Add an email first",
      changeHint: "The bot opens — tap Start in the account that should get the issue. The old one is disconnected.",
      podcast: "Issue as audio",
      podcastHint: "A recording of the issue: in Telegram it comes with the message, in email as a Listen link.",
      podcastSaved: "Saved",
      timezone: "Time zone",
    ...
    email: {
      title: "Email",
      description: "The issue by email: the same list of headlines and a link to your feed.",
      address: (email: string) => `Address: ${email}.`,
      digest: "Send the issue by email",
      digestHint: "Every morning, at the same time as Telegram.",
      digestOn: "Emails on",
      digestOff: "Emails off",
      label: "Email address",
      placeholder: "you@example.com",
      confirm: "Confirm address",
      sent: (email: string) => `We sent an email to ${email} — tap Confirm in it.`,
      change: "Change address",
      cancel: "Cancel",
      remove: "Remove email",
      removed: "Email removed",
      invalid: "That doesn't look like an email address",
      same: "This address is already connected",
      taken: "This address signs in to another Reporta profile",
      tooSoon: "The email is on its way — wait a minute",
      failed: "Couldn't send the email. Try again in a minute",
      noAddress: "Add an address first",
      onlyWay: "You can't remove it: it's your only way to sign in. Connect Telegram first",
      confirmed: "Email confirmed — the issue will arrive by email too.",
      confirmTaken: "This address already signs in to another Reporta profile.",
      confirmExpired: "The confirmation link expired — send it again.",
    },
    kindle: {
