...
export const plans = {
  ...
  table: {
    ...
    upgradeNote: "Right away; the difference is charged now",
    upgradeTrialNote: "Right away; your free trial continues",
    downgradeNote: "Right away; the unused rest is credited to your next payment",
    toFreeNote: "Your paid plan works until the end of the paid period",
  ...
  about: {
    ...
    deleteBlockedSubscription: "Cancel your subscription first, or it will keep charging you.",
