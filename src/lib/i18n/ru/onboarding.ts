...
export const onboarding: typeof En = {
  ...
  login: {
    linkExpired: "Ссылка устарела или вход не удался — попробуй ещё раз",
    tagline: "Надёжные новости каждое утро",
    viaTelegram: "Войти через Telegram",
    botHintBefore: "Напиши боту ",
    botHintAfter: " — он пришлёт ссылку на ленту. Она работает 10 минут.",
    viaGoogle: "Войти через Google",
    pricingLink: "Цены",
    termsLink: "Условия",
    privacyLink: "Конфиденциальность",
    refundLink: "Возврат",
    viaEmail: "Войти по почте",
    emailLabel: "Почта",
    ...
    mail: {
      subject: "Ссылка для входа в Reporta",
      intro: "Нажми кнопку, чтобы войти в Reporta. Ссылка работает 30 минут.",
      button: "Войти",
      outro: "Если письмо пришло по ошибке, просто не обращай на него внимания.",
    },
  },
  channels: {
    ...
    detectedLanguage: (language) => `по постам: ${language}`,
  ...
  opinionDialog: {
    ...
    aboutYouTitle: "Сказано о тебе — это правда? Если нет, убери",
    variant1: "Первый вариант",
    variant2: "Второй вариант",
    noDraftForNetwork: "Для этой сети модель ничего не дала — попробуй ещё раз.",
    lever: (what) => `Прокачан: ${what}`,
    levers: {
      number: "число в первой строке",
      verdict: "вердикт вместо пересказа",
      segment: "названо, кого касается",
      specifics: "цифры и имена вместо общих слов",
    },
    weakTitle: "Что обычно тянет пост вниз",
    weak: {
      company: "начинается с компании и глагола — самый слабый вход",
      no_number: "ни одной цифры — конкретика почти вдвое поднимает пересылки",
      middle: "300–900 знаков — длинно для реакции, мало для разбора",
      ask: "«что думаете?» в конце — худший призыв; спроси конкретное",
    },
