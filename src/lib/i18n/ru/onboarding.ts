...
export const onboarding: typeof En = {
  ...
  channels: {
    ...
    sourcesDescription:
      "Черновик выходит твоим, когда лента прочитала десяток твоих постов. Публичный канал Telegram, блог по RSS и аккаунт X читаются по ссылке. LinkedIn и Threads наружу не отдают ничего — оттуда вставь посты текстом. Отметка сверху на чтение не влияет: она про то, куда ты публикуешь.",
