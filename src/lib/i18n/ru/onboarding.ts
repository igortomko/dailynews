...
export const onboarding: typeof En = {
  ...
  channels: {
    ...
    styleEdit: "Изменить стиль",
    styleDialogTitle: "Как писать черновики",
    styleDialogText:
      "Опиши своими словами, в каком стиле писать: форма поста, чем открываешь, тон, длина, эмодзи. Или нажми «Изучи мой стиль» — прочитаем твои посты и разберём их сюда, а ты поправишь. Готовый skill-файл тоже подойдёт.",
    stylePlaceholder:
