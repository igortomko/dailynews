 ...
 * карточке заново.
 *
 * `t` по умолчанию — русские подписи. Весь живой код язык передаёт; умолчание
 * осталось для утверждений, которые зовут эту функцию без читателя и сверяют
 * русский текст напрямую.
 */
