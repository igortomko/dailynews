...
- `reading-v2.11` removes the prose-first bias, supplies bounded exact quote candidates, and validates quotations against source text. Current-edition list/quote examples are editorial rearrangements of verified summaries, not evidence of model format distribution. A further paid model replay was not run after reaching the daily cap.
